...
You have subprocesses - AI agents. For example, agents backed by Gemini, Claude, or Codex. You give them a goal, they plan, run commands, read files, write code, and iterate. They can handle real tasks. Not perfectly. Not independently. But meaningfully.
...
<Details withBackground title="Why you should always verify the results?">
...
<Details withBackground title="A simplified capacity model">
...
<Details withBackground title="To be fair, the model is too simple">
