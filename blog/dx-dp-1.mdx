...
When wiring things up, the agent only needs the props on one side and the data on the other: a much smaller context than "the entire app". {/* lever: c - wiring does not require keeping rendering logic in your head */}
